  ...
  return (
    <>
            ...
            <section id="projects">
                ...
                <article>
                    <div className="text">
                        ...
                        <p className="blackbox">I love to read, both fiction and non-fiction, go on hikes, and constantly evolve in my profession by learning new things. I'm a father of two kids with a third on the way, and currently live with my family in Sweden.</p>
                    ...
                    <img src={getImageURL("profile2.png")} alt="Profile picture of Jonatan." />
                </article>
            </section>
        </div>
        ...
        <div className="gradient"></div>
            ...
            <div className="section-secondary-color">
            <section id="projects">
                <h2>Highlighted examples of work</h2>
                <article>
                    <div className="text">
